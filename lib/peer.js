 ...
 * using the standard bitcoin(Hush) protocol. A Peer instance represents one connection
 * on the Hush network. To create a new peer connection provide the host and port
